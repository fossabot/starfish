...
export const chassis: {
  ...
  starter1: {
    ...
    mass: 5000,
    basePrice: 2 * game.itemPriceMultiplier,
    slots: 5,
    agility: 1.0,
    maxCargoSpace: 15,
    rarity: 0.5,
  ...
  starter3: {
    ...
    description: `They say that a goldfish will grow to the size of its container. The goldfish in this bowl are feeling cramped, restrained to shallower waters.`,
    mass: 5000,
    basePrice: 60 * game.itemPriceMultiplier,
    slots: 6,
    agility: 1.0,
    maxCargoSpace: 30,
    rarity: 1.5,
  ...
  fighter2: {
    ...
    mass: 4000,
    basePrice: 190 * game.itemPriceMultiplier,
    slots: 6,
    agility: 1.3,
    maxCargoSpace: 30,
    rarity: 2,
  ...
  fighter3: {
    ...
    mass: 4000,
    basePrice: 690 * game.itemPriceMultiplier,
    slots: 7,
    agility: 1.35,
    maxCargoSpace: 40,
    rarity: 3,
  ...
  hauler1: {
    ...
    mass: 8000,
    basePrice: 20 * game.itemPriceMultiplier,
    slots: 6,
    agility: 0.7,
    maxCargoSpace: 60,
    rarity: 4,
  ...
  hauler3: {
    ...
    description: `Made to serve aquatic life with migratory instincts. A bit cumbersome in a firefight, but allows for superior cargo space compared to other models in its price range. Equipped with CV radio extender.`,
    mass: 12600,
    basePrice: 520 * game.itemPriceMultiplier,
    slots: 7,
    agility: 0.75,
    maxCargoSpace: 100,
    rarity: 10,
  ...
  sailer2: {
    ...
    description: `Exceptionally light and nimble, this craft excels at getting from A to B quickly.`,
    mass: 2100,
    basePrice: 230 * game.itemPriceMultiplier,
    slots: 6,
    agility: 1.45,
    maxCargoSpace: 40,
    rarity: 7,
  ...
  sailer3: {
    ...
    description: `Exceptionally light and nimble, this craft excels at getting from A to B quickly.`,
    mass: 2100,
    basePrice: 620 * game.itemPriceMultiplier,
    slots: 6,
    agility: 1.5,
    maxCargoSpace: 50,
    rarity: 10,
  ...
  mega2: {
    ...
    mass: 70000,
    basePrice: 1370 * game.itemPriceMultiplier,
    slots: 18,
    agility: 0.35,
    maxCargoSpace: 400,
    rarity: 18,
  ...
  mega3: {
    ...
    mass: 95000,
    basePrice: 3270 * game.itemPriceMultiplier,
    slots: 21,
    agility: 0.25,
    maxCargoSpace: 500,
    rarity: 25,
