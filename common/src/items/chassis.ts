...
export const chassis: {
  ...
  starter1: {
    ...
    mass: 5000,
    basePrice: 20000 * game.itemPriceMultiplier,
    slots: 5,
    agility: 1.0,
    maxCargoSpace: 15,
    rarity: 0.5,
  ...
  starter2: {
    ...
    description: `They say that a goldfish will grow to the size of its container. The goldfish in this bowl are feeling cramped, restrained to shallower waters.`,
    mass: 5000,
    basePrice: 62000 * game.itemPriceMultiplier,
    slots: 6,
    agility: 1.0,
    maxCargoSpace: 25,
    rarity: 1,
  ...
  hauler1: {
    ...
    mass: 8000,
    basePrice: 78000 * game.itemPriceMultiplier,
    slots: 6,
    agility: 0.7,
    maxCargoSpace: 45,
    rarity: 4,
  ...
  sailer1: {
    ...
    mass: 2000,
    basePrice: 52000 * game.itemPriceMultiplier,
    slots: 5,
    agility: 1.4,
    maxCargoSpace: 15,
    rarity: 4,
  ...
  mega1: {
    ...
    mass: 60000,
    basePrice: 710000 * game.itemPriceMultiplier,
    slots: 15,
    agility: 0.45,
    maxCargoSpace: 300,
    rarity: 12,
  ...
  mega2: {
    ...
    mass: 70000,
    basePrice: 970000 * game.itemPriceMultiplier,
    slots: 18,
    agility: 0.35,
    maxCargoSpace: 400,
    rarity: 18,
