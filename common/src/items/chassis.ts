...
export const chassis: {
  ...
  tiny1: {
    ...
    mass: 18000 * game.itemMassMultiplier,
    basePrice: { credits: 0 },
    slots: 2,
    agility: 0.2,
    maxCargoSpace: 1,
  ...
  starter1: {
    ...
    mass: 5000 * game.itemMassMultiplier,
  ...
  hauler1: {
    ...
    mass: 8000 * game.itemMassMultiplier,
  ...
  hauler3: {
    ...
    description: `Made to serve aquatic life with migratory instincts. A bit cumbersome in a firefight, but allows for superior cargo space compared to other models in its price range. Equipped with CV radio extender.`,
    mass: 12600 * game.itemMassMultiplier,
  ...
  sailer2: {
    ...
    description: `Exceptionally light and nimble, this craft excels at getting from A to B quickly.`,
    mass: 2100 * game.itemMassMultiplier,
  ...
  mega1: {
    ...
    mass: 60000 * game.itemMassMultiplier,
  ...
  mega2: {
    ...
    mass: 70000 * game.itemMassMultiplier,
  ...
  mega3: {
    ...
    mass: 95000 * game.itemMassMultiplier,
