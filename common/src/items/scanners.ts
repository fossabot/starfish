...
export const scanners: {
  ...
  peek2: {
    ...
    mass: 1100,
    basePrice: 9 * game.itemPriceMultiplier,
    rarity: 8,
    sightRange: 0.1,
    shipScanRange: 0.1,
    maxHp: 1,
  ...
  wide1: {
    ...
    mass: 3000,
    basePrice: 91 * game.itemPriceMultiplier,
    rarity: 1.3,
    sightRange: 0.45,
    shipScanRange: 0.2,
    maxHp: 4,
  ...
  wide2: {
    ...
    description: `Inspired by the evolution of hyper-sensitive eyes that evolved in the deep waters of Earth's oceans, this scanner has a wider range than most, but can only see a limited amount of information about nearby ships.`,
    mass: 3400,
    basePrice: 280 * game.itemPriceMultiplier,
    rarity: 4,
    sightRange: 0.6,
    shipScanRange: 0.28,
    maxHp: 4,
  ...
  wide3: {
    ...
    description: `Inspired by the evolution of hyper-sensitive eyes that evolved in the deep waters of Earth's oceans, this scanner has a wider range than most, but can only see a limited amount of information about nearby ships.`,
    mass: 3800,
    basePrice: 910 * game.itemPriceMultiplier,
    rarity: 10,
    sightRange: 0.75,
    shipScanRange: 0.35,
    maxHp: 4,
  ...
  shipscanner2: {
    ...
    description: `The distance that this part protrudes from the ship makes it an easy target, but it excels at seeing exactly who's around you.`,
    mass: 700,
    basePrice: 180 * game.itemPriceMultiplier,
    rarity: 5.5,
    sightRange: 0.45,
    shipScanRange: 0.42,
    reliability: 0.7,
  ...
  shipscanner3: {
    ...
    description: `The distance that this part protrudes from the ship makes it an easy target, but it excels at seeing exactly who's around you.`,
    mass: 700,
    basePrice: 370 * game.itemPriceMultiplier,
    rarity: 8.5,
    sightRange: 0.6,
    shipScanRange: 0.57,
    reliability: 0.7,
  ...
  treasure1: {
    ...
    mass: 4200,
    basePrice: 450 * game.itemPriceMultiplier,
    rarity: 4,
    sightRange: 0.47,
    shipScanRange: 0.35,
