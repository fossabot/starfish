...
export const engines: {
  ...
  starter2: {
    ...
    mass: 3900,
    basePrice: 21 * game.itemPriceMultiplier,
    rarity: 1,
  ...
  starter3: {
    ...
    mass: 3900,
    basePrice: 49 * game.itemPriceMultiplier,
    rarity: 1.5,
  ...
  basic3: {
    ...
    description: `Gains velocity through an oscillating power flux located at the rear of the ship.`,
    mass: 5000,
    basePrice: 350 * game.itemPriceMultiplier,
    rarity: 7,
  ...
  glass3: {
    ...
    description: `An ultraviolet fin extends gloriously from the ship. As swift and as vulnerable as it is beautiful.`,
    mass: 300,
    basePrice: 1770 * game.itemPriceMultiplier,
    rarity: 12,
  ...
  heavy3: {
    ...
    description: `Big fin. Fin big.`,
    mass: 12000,
    basePrice: 600 * game.itemPriceMultiplier,
    rarity: 12,
