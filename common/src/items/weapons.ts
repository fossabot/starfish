...
export const weapons: {
  ...
  drone1: {
    ...
    rarity: 1,
    reliability: 1,
    damage: 0.2 * game.weaponDamageMultiplier,
  ...
  tiny1: {
    ...
    mass: 400 * game.itemMassMultiplier,
    basePrice: { credits: 7 * game.itemPriceMultiplier },
    range: 0.075,
    rarity: 0.4,
  ...
  cannon2: {
    ...
    basePrice: { credits: 35 * game.itemPriceMultiplier },
    range: 0.175,
    rarity: 3,
  ...
  sniper2: {
    ...
    description: `Able to shoot down targets from an impressive distance, the Harpoon class of weapons is feared by slow-moving craft who can't maneuver far enough from its reach.`,
    mass: 2700 * game.itemMassMultiplier,
    basePrice: { credits: 119 * game.itemPriceMultiplier },
    range: 0.3,
    rarity: 4.9,
  ...
  sniper3: {
    ...
    basePrice: { credits: 470 * game.itemPriceMultiplier },
    range: 0.35,
    rarity: 9.5,
  ...
  saber1: {
    ...
    mass: 2200 * game.itemMassMultiplier,
  ...
  saber2: {
    ...
    description: `Gets its name from its short range and relatively quick recharge time. Dueling ships wielding Swordfish Sabers have been known to perform fantastic dogfights around the moons of Osiris.`,
    mass: 2600 * game.itemMassMultiplier,
    basePrice: { credits: 106 * game.itemPriceMultiplier },
    range: 0.075,
    rarity: 4.5,
  ...
  saber3: {
    ...
    description: `Gets its name from its short range and relatively quick recharge time. Dueling ships wielding Swordfish Sabers have been known to perform fantastic dogfights around the moons of Osiris.`,
    mass: 2600 * game.itemMassMultiplier,
    basePrice: { credits: 410 * game.itemPriceMultiplier },
    range: 0.085,
    rarity: 10,
  ...
  slowing1: {
    ...
    range: 0.13,
    rarity: 2,
    damage: 0.35 * game.weaponDamageMultiplier,
  ...
  slowing2: {
    ...
    range: 0.16,
    rarity: 6,
    damage: 0.4 * game.weaponDamageMultiplier,
  ...
  slowing3: {
    ...
    description: `Uses an electromagnetic tendril to ensnare even the zippiest of fish, making them ripe prey.`,
    mass: 1700 * game.itemMassMultiplier,
    basePrice: { credits: 480 * game.itemPriceMultiplier },
    range: 0.19,
    rarity: 11,
    damage: 0.5 * game.weaponDamageMultiplier,
    chargeRequired: 1.2 * 60 * 1000,
