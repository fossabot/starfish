...
export const weapons: {
  ...
  cannon2: {
    ...
    mass: 1400,
    basePrice: 35 * game.itemPriceMultiplier,
    range: 0.175,
    rarity: 3,
  ...
  sniper2: {
    ...
    description: `Able to shoot down targets from an impressive distance, the Harpoon class of weapons is feared by slow-moving craft who can't maneuver far enough from its reach.`,
    mass: 2700,
    basePrice: 119 * game.itemPriceMultiplier,
    range: 0.3,
    rarity: 4.9,
  ...
  sniper3: {
    ...
    description: `Able to shoot down targets from an impressive distance, the Harpoon class of weapons is feared by slow-moving craft who can't maneuver far enough from its reach.`,
    mass: 3000,
    basePrice: 470 * game.itemPriceMultiplier,
    range: 0.35,
    rarity: 9.5,
  ...
  saber2: {
    ...
    description: `Gets its name from its short range and relatively quick recharge time. Dueling ships wielding Swordfish Sabers have been known to perform fantastic dogfights around the moons of Osiris.`,
    mass: 2600,
    basePrice: 106 * game.itemPriceMultiplier,
    range: 0.055,
    rarity: 4.5,
  ...
  saber3: {
    ...
    description: `Gets its name from its short range and relatively quick recharge time. Dueling ships wielding Swordfish Sabers have been known to perform fantastic dogfights around the moons of Osiris.`,
    mass: 2600,
    basePrice: 410 * game.itemPriceMultiplier,
    range: 0.065,
    rarity: 10,
  ...
  blaster2: {
    ...
    description: ``,
    mass: 4600,
    basePrice: 305 * game.itemPriceMultiplier,
    range: 0.175,
    rarity: 7,
    damage: Number(game.weaponDamageMultiplier),
    baseCooldown: 1.2 * 60 * 1000,
  ...
  blaster3: {
    ...
    description: ``,
    mass: 5100,
    basePrice: 810 * game.itemPriceMultiplier,
    range: 0.22,
    rarity: 11,
    damage: 1.7 * game.weaponDamageMultiplier,
