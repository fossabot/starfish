...
exports.weapons = {
    tutorial1: {
        ...
        rarity: 9999999,
        reliability: 5,
        damage: 1.5 * game_1.default.weaponDamageMultiplier,
    ...
    tiny1: {
        ...
        range: 0.075,
        rarity: 0.4,
        damage: 0.5 * game_1.default.weaponDamageMultiplier,
    ...
    cannon1: {
        ...
        range: 0.15,
        rarity: 0.5,
        damage: 0.85 * game_1.default.weaponDamageMultiplier,
    ...
    cannon2: {
        ...
        range: 0.175,
        rarity: 3,
        damage: Number(game_1.default.weaponDamageMultiplier),
        baseCooldown: 1 * 60 * 1000,
        maxHp: 3,
    ...
    cannon3: {
        ...
        range: 0.22,
        rarity: 8,
        damage: 1.7 * game_1.default.weaponDamageMultiplier,
        baseCooldown: 1 * 60 * 1000,
        maxHp: 3,
    ...
    sniper1: {
        ...
        range: 0.25,
        rarity: 1.8,
        damage: 0.7 * game_1.default.weaponDamageMultiplier,
        baseCooldown: 2 * 60 * 1000,
        maxHp: 2,
    ...
    sniper2: {
        ...
        range: 0.3,
        rarity: 4.9,
        damage: 0.8 * game_1.default.weaponDamageMultiplier,
    ...
    sniper3: {
        ...
        range: 0.35,
        rarity: 9.5,
        damage: 0.9 * game_1.default.weaponDamageMultiplier,
    ...
    saber2: {
        ...
        range: 0.055,
        rarity: 4.5,
        damage: 2 * game_1.default.weaponDamageMultiplier,
        baseCooldown: 0.8 * 60 * 1000,
        maxHp: 4,
        reliability: 1.5,
        critChance: 0.1,
    ...
    saber3: {
        ...
        range: 0.065,
        rarity: 10,
        damage: 2.3 * game_1.default.weaponDamageMultiplier,
