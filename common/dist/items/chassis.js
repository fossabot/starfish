...
exports.chassis = {
    starter1: {
        ...
        mass: 5000,
        basePrice: 2 * gameConstants_1.default.itemPriceMultiplier,
        slots: 5,
        agility: 1.0,
        maxCargoSpace: 15,
        rarity: 0.5,
    ...
    starter2: {
        ...
        description: `They say that a goldfish will grow to the size of its container. The goldfish in this bowl are feeling cramped, restrained to shallower waters.`,
        mass: 5000,
        basePrice: 22 * gameConstants_1.default.itemPriceMultiplier,
        slots: 6,
        agility: 1.0,
        maxCargoSpace: 25,
        rarity: 1,
    ...
    starter3: {
        ...
        description: `They say that a goldfish will grow to the size of its container. The goldfish in this bowl are feeling cramped, restrained to shallower waters.`,
        mass: 5000,
        basePrice: 60 * gameConstants_1.default.itemPriceMultiplier,
        slots: 6,
        agility: 1.0,
        maxCargoSpace: 30,
        rarity: 1.5,
    ...
    fighter1: {
        ...
        mass: 4000,
        basePrice: 45 * gameConstants_1.default.itemPriceMultiplier,
        slots: 6,
        agility: 1.2,
        maxCargoSpace: 20,
        rarity: 1,
    ...
    fighter2: {
        ...
        mass: 4000,
        basePrice: 220 * gameConstants_1.default.itemPriceMultiplier,
        slots: 6,
        agility: 1.3,
        maxCargoSpace: 30,
        rarity: 2,
    ...
    fighter3: {
        ...
        mass: 4000,
        basePrice: 790 * gameConstants_1.default.itemPriceMultiplier,
        slots: 7,
        agility: 1.35,
        maxCargoSpace: 40,
        rarity: 3,
    ...
    hauler3: {
        ...
        description: `Made to serve aquatic life with migratory instincts. A bit cumbersome in a firefight, but allows for superior cargo space compared to other models in its price range. Equipped with CV radio extender.`,
        mass: 12600,
        basePrice: 520 * gameConstants_1.default.itemPriceMultiplier,
        slots: 7,
        agility: 0.75,
        maxCargoSpace: 100,
        rarity: 10,
    ...
    sailer1: {
        ...
        mass: 2000,
        basePrice: 52 * gameConstants_1.default.itemPriceMultiplier,
        slots: 5,
        agility: 1.4,
        maxCargoSpace: 30,
        rarity: 4,
    ...
    sailer2: {
        ...
        description: `Exceptionally light and nimble, this craft excels at getting from A to B quickly.`,
        mass: 2100,
        basePrice: 230 * gameConstants_1.default.itemPriceMultiplier,
        slots: 6,
        agility: 1.45,
        maxCargoSpace: 40,
        rarity: 7,
    ...
    sailer3: {
        ...
        description: `Exceptionally light and nimble, this craft excels at getting from A to B quickly.`,
        mass: 2100,
        basePrice: 620 * gameConstants_1.default.itemPriceMultiplier,
        slots: 6,
        agility: 1.5,
        maxCargoSpace: 50,
        rarity: 10,
    ...
    mega1: {
        ...
        mass: 60000,
        basePrice: 710 * gameConstants_1.default.itemPriceMultiplier,
        slots: 15,
        agility: 0.45,
        maxCargoSpace: 300,
        rarity: 12,
    ...
    mega2: {
        ...
        mass: 70000,
        basePrice: 1370 * gameConstants_1.default.itemPriceMultiplier,
        slots: 18,
        agility: 0.35,
        maxCargoSpace: 400,
        rarity: 18,
    ...
    mega3: {
        ...
        mass: 95000,
        basePrice: 3270 * gameConstants_1.default.itemPriceMultiplier,
        slots: 21,
        agility: 0.25,
        maxCargoSpace: 500,
        rarity: 25,
