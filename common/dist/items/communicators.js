...
exports.communicators = {
    starter1: {
        ...
        mass: 600,
        basePrice: 10000 * game_1.default.itemPriceMultiplier,
        rarity: 0.4,
        range: 0.22,
        antiGarble: 0.1,
        maxHp: 2,
    ...
    starter2: {
        ...
        mass: 800,
        basePrice: 18000 * game_1.default.itemPriceMultiplier,
        rarity: 2,
        range: 0.28,
        antiGarble: 0.2,
        maxHp: 3,
    ...
    distance1: {
        ...
        mass: 200,
        basePrice: 31000 * game_1.default.itemPriceMultiplier,
        rarity: 3,
        range: 0.75,
        antiGarble: -0.15,
        maxHp: 2,
    ...
    distance2: {
        ...
        description: `Using a passive organic sensor, this communications array can pick up messages from an impressive radius. Messages are filtered through a biological subsrate, however, so there is a clarity loss.`,
        mass: 250,
        basePrice: 40000 * game_1.default.itemPriceMultiplier,
        rarity: 7,
        range: 0.9,
        antiGarble: -0.1,
        maxHp: 2,
    ...
    distance3: {
        ...
        description: `Using a passive organic sensor, this communications array can pick up messages from an impressive radius. Messages are filtered through a biological subsrate, however, so there is a clarity loss.`,
        mass: 250,
        basePrice: 90000 * game_1.default.itemPriceMultiplier,
        rarity: 9,
        range: 1.3,
        antiGarble: -0.1,
        maxHp: 3,
    ...
    distance4: {
        ...
        description: `Using a passive organic sensor, this communications array can pick up messages from an impressive radius. Messages are filtered through a biological subsrate, however, so there is a clarity loss.`,
        mass: 250,
        basePrice: 120000 * game_1.default.itemPriceMultiplier,
        rarity: 12,
        range: 1.7,
        antiGarble: -0.1,
        maxHp: 3,
    ...
    clarity1: {
        ...
        mass: 600,
        basePrice: 30000 * game_1.default.itemPriceMultiplier,
        rarity: 1.1,
        range: 0.33,
        antiGarble: 0.3,
        maxHp: 2,
    ...
    clarity2: {
        ...
        description: `Sharp senses are crucial to stay alive in this fish-eat-fish world. This short-range communicator provides superior clarity to make sure broadcasts are clear and crisp.`,
        mass: 700,
        basePrice: 50000 * game_1.default.itemPriceMultiplier,
        rarity: 6,
        range: 0.4,
        antiGarble: 0.3,
        maxHp: 2,
    ...
    clarity3: {
        ...
        description: `Sharp senses are crucial to stay alive in this fish-eat-fish world. This short-range communicator provides superior clarity to make sure broadcasts are clear and crisp.`,
        mass: 1200,
        basePrice: 99000 * game_1.default.itemPriceMultiplier,
        rarity: 9,
        range: 0.5,
        antiGarble: 0.45,
        maxHp: 3,
