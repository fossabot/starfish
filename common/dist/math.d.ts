...
declare function vectorToRadians(
  coordPair?: CoordinatePair,
): number
declare function vectorToDegrees(
  coordPair?: CoordinatePair,
): number
...
declare function angleFromAToB(
  a?: CoordinatePair,
  b?: CoordinatePair,
): number
/**
 ...
 */
declare function angleDifference(
  a: number,
  b: number,
  signed?: boolean,
): number
declare function degreesToUnitVector(
  degrees?: number,
): CoordinatePair
declare function vectorToUnitVector(
  vector?: CoordinatePair,
): CoordinatePair
declare function unitVectorFromThisPointToThatPoint(
  thisPoint?: CoordinatePair,
  thatPoint?: CoordinatePair,
): CoordinatePair
declare function vectorToMagnitude(
  vector?: CoordinatePair,
): number
declare function pointIsInsideCircle(
  center?: CoordinatePair,
  point?: CoordinatePair,
  radius?: number,
): boolean
declare function randomInsideCircle(
  radius: number,
): CoordinatePair
declare function randomSign(): 1 | -1
declare function randomInRange(a: number, b: number): number
declare function lottery(
  odds: number,
  outOf: number,
): boolean
declare function randomBetween(
  start: number,
  end: number,
): number
