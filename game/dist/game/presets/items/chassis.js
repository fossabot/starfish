...
exports.chassis = {
    starter1: {
        ...
        mass: 5000,
        basePrice: 20000 * dist_1.default.itemPriceMultiplier,
        slots: 4,
        agility: 1.0,
        maxCargoSpace: 15,
        rarity: 0.5,
    ...
    starter2: {
        ...
        description: `They say that a goldfish will grow to the size of its container. The goldfish in this bowl are feeling cramped, restrained to shallower waters.`,
        mass: 5000,
        basePrice: 62000 * dist_1.default.itemPriceMultiplier,
        slots: 5,
        agility: 1.0,
        maxCargoSpace: 25,
        rarity: 1,
    ...
    hauler1: {
        ...
        mass: 8000,
        basePrice: 78000 * dist_1.default.itemPriceMultiplier,
        slots: 5,
        agility: 0.7,
        maxCargoSpace: 45,
        rarity: 4,
    ...
    hauler2: {
        ...
        description: `Made to serve aquatic life with migratory instincts. A bit cumbersome in a firefight, but allows for superior cargo space compared to other models in its price range.`,
        mass: 9600,
        basePrice: 210000 * dist_1.default.itemPriceMultiplier,
        slots: 5,
        agility: 0.75,
        maxCargoSpace: 55,
        rarity: 8,
    ...
    sailer1: {
        ...
        mass: 2000,
        basePrice: 52000 * dist_1.default.itemPriceMultiplier,
        slots: 4,
        agility: 1.4,
        maxCargoSpace: 15,
        rarity: 4,
    ...
    sailer2: {
        ...
        description: `Exceptionally light and nimble, this craft excels at getting from A to B quickly.`,
        mass: 2100,
        basePrice: 130000 * dist_1.default.itemPriceMultiplier,
        slots: 5,
        agility: 1.45,
        maxCargoSpace: 25,
        rarity: 7,
    ...
    mega1: {
        ...
        mass: 60000,
        basePrice: 710000 * dist_1.default.itemPriceMultiplier,
        slots: 14,
        agility: 0.45,
        maxCargoSpace: 300,
        rarity: 12,
    ...
    mega2: {
        ...
        mass: 70000,
        basePrice: 970000 * dist_1.default.itemPriceMultiplier,
        slots: 17,
        agility: 0.35,
        maxCargoSpace: 400,
        rarity: 18,
