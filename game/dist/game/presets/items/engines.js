...
exports.engines = {
    ...
    starter1: {
        ...
        description: `Expels repeated payloads of hyrdocarbon-based fuel that explode outside of the ship, forming a trail that looks not unlike bubbles. A highly inefficient form of propulsion.`,
        mass: 4000,
        basePrice: 17000 * dist_1.default.itemPriceMultiplier,
        rarity: 0.4,
    ...
    starter2: {
        ...
        mass: 3900,
        basePrice: 45000 * dist_1.default.itemPriceMultiplier,
        rarity: 2,
    ...
    basic1: {
        ...
        mass: 5000,
        basePrice: 80000 * dist_1.default.itemPriceMultiplier,
        rarity: 3,
    ...
    glass2: {
        ...
        description: `An ultravoilet fin extends gloriously from the ship. As swift and as vulnerable as it is beautiful.`,
        mass: 300,
        basePrice: 390000 * dist_1.default.itemPriceMultiplier,
        rarity: 9,
    ...
    glass3: {
        ...
        description: `An ultravoilet fin extends gloriously from the ship. As swift and as vulnerable as it is beautiful.`,
        mass: 300,
        basePrice: 770000 * dist_1.default.itemPriceMultiplier,
        rarity: 12,
