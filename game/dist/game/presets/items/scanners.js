...
exports.scanners = {
    starter1: {
        ...
        mass: 2000,
        basePrice: 14000 * dist_1.default.itemPriceMultiplier,
        rarity: 0.6,
        sightRange: 0.3,
        shipScanRange: 0.1,
        maxHp: 3,
    ...
    starter2: {
        ...
        mass: 2000,
        basePrice: 43000 * dist_1.default.itemPriceMultiplier,
        rarity: 3,
        sightRange: 0.35,
        shipScanRange: 0.13,
        reliability: 1.2,
    ...
    peek2: {
        ...
        mass: 1100,
        basePrice: 70000 * dist_1.default.itemPriceMultiplier,
        rarity: 8,
        sightRange: 0.1,
        shipScanRange: 0.1,
        maxHp: 1,
    ...
    peek3: {
        ...
        mass: 1500,
        basePrice: 190000 * dist_1.default.itemPriceMultiplier,
        rarity: 10,
        sightRange: 0.1,
        shipScanRange: 0.1,
        maxHp: 1,
    ...
    wide1: {
        ...
        mass: 3000,
        basePrice: 71000 * dist_1.default.itemPriceMultiplier,
        rarity: 1.3,
        sightRange: 0.45,
        shipScanRange: 0.2,
        maxHp: 4,
    ...
    wide3: {
        ...
        description: `Inspired by the evolution of hyper-sensitive eyes that evolved in the deep waters of Earth's oceans, this scanner has a wider range than most, but can only see a limited amount of information about nearby ships.`,
        mass: 3800,
        basePrice: 310000 * dist_1.default.itemPriceMultiplier,
        rarity: 8,
        sightRange: 0.75,
        shipScanRange: 0.35,
        maxHp: 4,
    ...
    shipscanner3: {
        ...
        description: `The distance that this part protrudes from the ship makes it an easy target, but it excels at seeing exactly who's around you.`,
        mass: 700,
        basePrice: 270000 * dist_1.default.itemPriceMultiplier,
        rarity: 8.5,
        sightRange: 0.6,
        shipScanRange: 0.57,
        reliability: 0.7,
