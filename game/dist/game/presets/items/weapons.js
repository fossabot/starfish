...
exports.weapons = {
    ...
    cannon2: {
        ...
        mass: 1400,
        basePrice: 23000 * dist_1.default.itemPriceMultiplier,
        range: 0.175,
        rarity: 3,
        damage: 1,
        baseCooldown: 1 * 60 * 1000,
    ...
    saber1: {
        ...
        mass: 2200,
        basePrice: 48000 * dist_1.default.itemPriceMultiplier,
        range: 0.05,
        rarity: 1.75,
        damage: 1.7,
    ...
    saber2: {
        ...
        description: `Gets its name from its short range and relatively quick recharge time. Dueling ships wielding Swordfish Sabers have been known to perform fantastic dogfights around the moons of Osiris.`,
        mass: 2600,
        basePrice: 91000 * dist_1.default.itemPriceMultiplier,
        range: 0.055,
        rarity: 4.5,
        damage: 2,
        baseCooldown: 0.8 * 60 * 1000,
