...
export const communicators: {
  ...
  starter1: {
    ...
    mass: 600,
    basePrice: 100 * c.itemPriceMultiplier,
    rarity: 0.4,
    range: 0.22,
    antiGarble: 0.1,
    maxHp: 2,
  ...
  distance1: {
    ...
    mass: 200,
    basePrice: 310 * c.itemPriceMultiplier,
    rarity: 1,
    range: 0.75,
    antiGarble: -0.15,
    maxHp: 2,
  ...
  distance2: {
    ...
    description: `Using a passive organic sensor, this communications array can pick up messages from an impressive radius. Messages are filtered through a biological subsrate, however, so there is a clarity loss.`,
    mass: 250,
    basePrice: 400 * c.itemPriceMultiplier,
    rarity: 3,
    range: 0.9,
    antiGarble: -0.1,
    maxHp: 2,
  ...
  distance3: {
    ...
    description: `Using a passive organic sensor, this communications array can pick up messages from an impressive radius. Messages are filtered through a biological subsrate, however, so there is a clarity loss.`,
    mass: 250,
    basePrice: 900 * c.itemPriceMultiplier,
    rarity: 5,
    range: 1.3,
    antiGarble: -0.1,
    maxHp: 3,
  ...
  clarity1: {
    ...
    mass: 600,
    basePrice: 300 * c.itemPriceMultiplier,
    rarity: 1.1,
    range: 0.33,
    antiGarble: 0.3,
    maxHp: 2,
  ...
  clarity3: {
    ...
    description: `Sharp senses are crucial to stay alive in this fish-eat-fish world. This short-range communicator provides superior clarity to make sure broadcasts are clear and crisp.`,
    mass: 1200,
    basePrice: 990 * c.itemPriceMultiplier,
    rarity: 4.5,
    range: 0.5,
    antiGarble: 0.45,
    maxHp: 3,
